...
import { SearchX, Lightbulb, Hash } from "lucide-react";
...
export function TagPageView({ tag, sections, relatedTags }: TagPageViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {relatedTags.length > 0 && (
        <div>
          <p className="mb-2 text-sm text-muted-foreground">関連タグ:</p>
