        ...
        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            ...
            >
              ...
              <div className="absolute left-0 right-0 bottom-0 bg-gradient-to-t from-background/90 to-transparent p-6 transition-opacity duration-300 group-hover:opacity-0">
