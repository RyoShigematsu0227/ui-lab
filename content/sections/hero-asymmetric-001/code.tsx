      ...
      <div className="relative mx-auto min-h-screen max-w-7xl px-6 py-24">
        <div className="grid min-h-screen items-center gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7">
            ...
            {/* Large heading */}
            <h1 className="text-4xl font-light leading-[1.1] tracking-tight text-white/90 sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">
              We create
              <br />
            ...
            {/* Horizontal line */}
            <div className="my-10 h-px w-32 bg-white/20" />
          ...
          <div className="flex flex-col justify-between lg:col-span-5 lg:h-[60vh]">
            ...
            <div className="mt-8 lg:mt-0">
              <button className="group flex w-full items-center justify-between border border-white/10 bg-white/[0.02] p-6 transition-all hover:border-white/20 hover:bg-white/[0.05]">
                <span className="text-xs font-medium uppercase tracking-[0.2em] text-white/70">
                  Start a Project
                </span>
                <svg
                  className="h-4 w-4 text-white/50 transition-transform group-hover:translate-x-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        {/* Bottom bar */}
        <div className="absolute bottom-8 left-6 right-6 flex items-center justify-between border-t border-white/10 pt-6">
