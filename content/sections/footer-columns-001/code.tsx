...
export function FooterColumns001() {
  const columns = [
    {
      title: "プロダクト",
      links: [
      ...
      <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-5">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-6 text-xs font-light leading-relaxed tracking-wide text-muted-foreground">
              クリエイティブとテクノロジーの
              <br />
              交差点から、新しい価値を。
            </p>
        ...
        {/* 区切り線 */}
        <div className="mt-20 h-px bg-border/40" />

        {/* 下部: コピーライト + ソーシャル */}
        <div className="mt-8 flex flex-col items-center justify-between gap-6 sm:flex-row">
          <p className="text-[11px] font-light tracking-widest text-muted-foreground/60">
            &copy; 2024 Studio Inc. All rights reserved.
          </p>
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              href="#"
              className="text-muted-foreground/40 transition-colors duration-200 hover:text-foreground"
              aria-label="Twitter"
            >
              <svg
                className="h-4 w-4"
