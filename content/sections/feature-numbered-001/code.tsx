    ...
    <section className="relative bg-slate-950 py-32">
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mb-20 lg:mb-24">
          ...
          <h2 className="max-w-2xl text-3xl font-light tracking-tight text-white/90 sm:text-4xl">
        ...
        <div className="space-y-0">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group border-t border-white/10 py-10 first:border-t-0 lg:py-12"
            >
              <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-16">
                {/* Number */}
                <div className="shrink-0">
                  <span className="text-5xl font-extralight tracking-tight text-white/10 transition-colors group-hover:text-white/20 lg:text-6xl">
                    {feature.number}
                  </span>
                </div>
                ...
                <div className="flex-1">
                  <h3 className="mb-4 text-xl font-light tracking-wide text-white/90 lg:text-2xl">
                    {feature.title}
                  </h3>
                ...
                {/* Arrow */}
                <div className="hidden shrink-0 text-white/20 transition-colors group-hover:text-white/40 lg:block">
                  <svg
                    className="h-5 w-5"
                    fill="none"
                    stroke="currentColor"
