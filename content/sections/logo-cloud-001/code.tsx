export function LogoCloud001() {
  const logos = [
    ...
    },
    {
      name: "Vercel",
      svg: (
        <svg className="h-6 w-auto" viewBox="0 0 116 100" fill="currentColor">
    ...
    },
    {
      ...
      svg: (
        <svg className="h-8 w-auto" viewBox="0 0 38 57" fill="none">
          <path className="fill-foreground" d="M19 28.5a9.5 9.5 0 1 1 19 0 9.5 9.5 0 0 1-19 0z" />
          <path className="fill-muted-foreground/60" d="M0 47.5A9.5 9.5 0 0 1 9.5 38H19v9.5a9.5 9.5 0 1 1-19 0z" />
          <path className="fill-muted-foreground/40" d="M19 0v19h9.5a9.5 9.5 0 1 0 0-19H19z" />
          <path className="fill-muted-foreground/70" d="M0 9.5A9.5 9.5 0 0 0 9.5 19H19V0H9.5A9.5 9.5 0 0 0 0 9.5z" />
          <path className="fill-muted-foreground/50" d="M0 28.5A9.5 9.5 0 0 0 9.5 38H19V19H9.5A9.5 9.5 0 0 0 0 28.5z" />
        </svg>
      ),
    },
  ];
  ...
  return (
    <section className="bg-background py-20 border-y border-border">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Logos Grid */}
        <div className="mt-12 grid grid-cols-2 gap-8 sm:gap-12 md:grid-cols-3 lg:grid-cols-6">
          {logos.map((logo) => (
            <div
              key={logo.name}
              className="flex items-center justify-center text-muted-foreground/60 opacity-60 transition-all duration-300 hover:text-foreground hover:opacity-100"
            >
              {logo.svg}
            </div>
          ))}
        ...
        <div className="mt-14 text-center">
          <p className="text-sm tracking-wide text-muted-foreground/70">
            Join <span className="font-medium text-foreground">5,000+</span> companies
